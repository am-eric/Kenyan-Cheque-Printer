...
//     try {
//       const n = parseInt(num);
//       // Using the library logic you provided
//       let words = toWords(n);
      
//       // Convert to uppercase
//       words = words.toUpperCase();
      
//       // Add commas after MILLION, BILLION, THOUSAND
//       words = words.replace(/ BILLION /g, ' BILLION, ');
//       words = words.replace(/ MILLION /g, ' MILLION, ');
//       words = words.replace(/ THOUSAND /g, ' THOUSAND, ');
      
//       // Add "AND" before the last part after HUNDRED
//       const parts = words.split(', ');
//       const formattedParts = parts.map(part => {
//         if (part.includes(' HUNDRED ')) {
//           const hundredSplit = part.split(' HUNDRED ');
...
//     } catch (error) {
//       console.error('Error converting number to words:', error);
//       // Fallback if library fails or isn't installed yet
//       return 'Error: Run "npm install number-to-words"';
//     }
//   };
...
//     // Auto-generate words using library only when amount changes
//     if (name === 'amount') {
//       setAmountInWords(numberToWords(value));
//     }
//   };
...
//       id: Date.now(),
//       ...formData,
//       amountInWords // Saves the current state of words (whether auto or manual)
//     };
...
//     // Use saved words if they exist (preserving manual edits), otherwise regenerate
//     if (record.amountInWords) {
//       setAmountInWords(record.amountInWords);
//     } else {
//       setAmountInWords(numberToWords(record.amount));
...
//             position: absolute; 
//             left: 135mm; 
//             top: calc(var(--cheque-height) - 88mm);
//             letter-spacing: 1px;
//             font-size: 10pt;
//           }
...
//             position: absolute; 
//             left: 20mm; 
//             top: calc(var(--cheque-height) - 50mm);
//             text-transform: uppercase;
//             font-size: 10pt;
//           }
...
//             position: absolute; 
//             left: 135mm; 
//             top: calc(var(--cheque-height) - 55mm);
//             font-weight: bold;
//             font-size: 12pt;
//           }
...
//             position: absolute; 
//             left: 40mm; 
//             top: calc(var(--cheque-height) - 40mm);
//             text-transform: uppercase;
//             font-size: 8pt;
//           }
...
//             position: absolute; 
//             left: 7mm; 
//             top: calc(var(--cheque-height) - 30mm);
//             text-transform: uppercase;
//             font-size: 8pt;
//           }
...
//             position: absolute; 
//             left: 7mm; 
//             top: calc(var(--cheque-height) - 18mm);
//             font-size: 9pt;
//           }
...
//                         <span className="font-bold">⚠️ Printer Check:</span> Please ensure a <span className="font-bold underline">{formData.bank}</span> cheque leaf is inserted in the printer tray.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
